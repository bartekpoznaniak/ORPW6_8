...
class App(ctk.CTk):
    def __init__(self):
        ...
        button_frame.pack(pady=20) # Ta rama ma margines od góry okna
        
        for i in range(4):
            btn = ctk.CTkButton(
                button_frame, # Umieszczamy przycisk w ramie, a nie w głównym oknie
                image=self.img_on,
                text=f"Przycisk {i+1}", 
                width=150,
                height=40,
            ...
            # pady=0, padx=0, sticky="nsew" sprawiają, że przyciski wypełniają całą dostępną przestrzeń komórki siatki i dotykają się krawędziami
            btn.grid(row=i, column=0, pady=0, padx=0, sticky="nsew") 
